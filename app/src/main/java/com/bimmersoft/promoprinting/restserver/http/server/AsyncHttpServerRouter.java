...
import com.bimmersoft.promoprinting.restserver.http.AsyncHttpHead;
import com.bimmersoft.promoprinting.restserver.http.AsyncHttpPost;
import com.bimmersoft.promoprinting.restserver.http.WebSocketImpl;
...
public class AsyncHttpServerRouter implements RouteMatcher {
    ...
    abstract class AsyncHttpServerRequestImpl extends com.bimmersoft.promoprinting.restserver.http.server.AsyncHttpServerRequestImpl {
        Matcher matcher;
        @Override
