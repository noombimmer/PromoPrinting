...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        private SwitchPreference ZPLSwith;
        private SwitchPreference SVCSwith;
        @Override
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            ZPLSwith = (SwitchPreference) findPreference("enbale_zpl_switch");
            SVCSwith = (SwitchPreference) findPreference("print_svc_switch");
...
//            bindPreferenceSummaryToValue(findPreference("enbale_zpl_switch"));
            ...
            ZPLSwith.setOnPreferenceChangeListener(new Preference.OnPreferenceChangeListener() {
                ...
                public boolean onPreferenceChange(Preference preference, Object newValue) {
                    boolean ZPL = (Boolean) newValue;
                    if(ZPL){
                        Log.w("Info","GET  to ZPL Mode." +  RestAPI.PRINT_MODE);
                        RestAPI.PRINT_MODE = RestAPI.PRNT_ZPL_MODE;
                        Log.w("Info","SET to ZPL Mode.");
                        Log.w("Info","GET  to ZPL Mode." +  RestAPI.PRINT_MODE);
                    }else{
                        Log.w("Info","GET  to ESC Mode." +  RestAPI.PRINT_MODE);
                        RestAPI.PRINT_MODE = RestAPI.PRNT_ESC_MODE;
                        Log.w("Info","SET to ESC Mode.");
                        Log.w("Info","GET  to ESC Mode." +  RestAPI.PRINT_MODE);
                    }
                    return true;
                }
